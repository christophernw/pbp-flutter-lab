...
class WatchListDetail extends StatelessWidget {
  ...
  const WatchListDetail(
      {Key? key, required this.watchListFields, required this.status})
      : super(key: key);
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: Text.rich(TextSpan(
                          ...
                          children: <InlineSpan>[
                            TextSpan(
                                text: status ? "watched" : "not watched",
                                style: const TextStyle(
                                    fontWeight: FontWeight.normal,
                                    fontSize: 17))
                          ]))),
